...
export default function UpdateListing() {
  ...
  //basically we have used useEffect hook to get the update listing page according to the listing id and we'll use that id to get info about that listing
  ...
  const handleformsubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`/backend/listing/update/${params.listingid}`, {
        //here we used params hook to get listing id from path or arguments of update-listing route
        method: "POST",
        headers: {
